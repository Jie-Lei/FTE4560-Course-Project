# -*- coding: utf-8 -*-
"""
Created on Mon Apr 26 21:59:04 2021
...
def index(x_train,x_test):
    ...
    df.to_excel(path_1+'CNN_15_V'+str(version)+'.xlsx')
    return df
#%%
version = 1
#%%
path = "D://OneDrive - CUHK-Shenzhen//桌面//FTE4560//Project 2 of FTE4560//china stock market//"
path_1 = 'D://OneDrive - CUHK-Shenzhen//桌面//FTE4560//Project 2 of FTE4560//Results//CNN_15//'
...
CNN = keras.Sequential([
    ...
    #layers.Conv1D(128,2,activation='relu'),
    #layers.Conv1D(100,2,activation='relu'),
...
plt.plot(date,y_pre,label='Predicted')
plt.plot(date,in_norm(y.values),label='GroundTruth')
plt.axvline(t0,ls='--',c="#338844")
plt.legend()
plt.savefig(path_1+'CNN_15_V'+str(version)+'.jpg',dpi=400)
#%%
...
plt.legend()
plt.savefig(path_1+'CNN_15_test_V'+str(version)+'.jpg',dpi=400)
#%%
...
plt.legend()
plt.savefig(path_1+'CNN_15_train_V'+str(version)+'.jpg',dpi=400)
